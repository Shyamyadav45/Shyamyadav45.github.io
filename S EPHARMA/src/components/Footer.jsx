...
const addressList = [
  { iconName: 'icofont-google-map', text: ' MAHARASHTRA,INDIA. ' },
  { iconName: 'icofont-phone', text: ' +919136544068 ' },
  { iconName: 'icofont-envelope', text: ' spharma45@gmail.com ' },
];
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="section-wrapper">
            <p>&copy; 2024 <Link to="/">S EPHARMA</Link> Designed by <a href="/" target='_blank' rel='noopener noreferrer'>SHYAM</a></p>
